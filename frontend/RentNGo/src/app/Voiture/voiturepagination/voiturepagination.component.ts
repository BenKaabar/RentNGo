...
@Component({
  selector: 'app-voiturepagination',
  templateUrl: './voiturepagination.component.html',
  styleUrls: ['./voiturepagination.component.css']
})
export class VoiturepaginationComponent implements AfterViewInit, OnInit {
  ...
  itemsPerPage: number = 9; // 3 lines * 3 cards per line
  totalPages: number = 0;
  pageNumbers: number[] = [];
