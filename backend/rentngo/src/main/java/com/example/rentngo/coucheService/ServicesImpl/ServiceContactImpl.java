...
public class ServiceContactImpl implements ServiceContact {
    ...
    @Override
    public Contact addContact(ContactRequestDTO contactRequestDTO, Long idClient) throws IOException {
    ...
    @Override
    public Contact updateContact(ContactRequestDTO contactRequestDTO, Long id, Long idClient) throws IOException {
